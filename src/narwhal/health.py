...
legs eject, health probes readmit (`GlobalScheduler.record_failure`). The
fleet-recovery finding — engines carry residual state for 11-16 minutes after
sustained load — says the degradation is visible in latency drift minutes
before it becomes failures. This tracker is the early instrument.
