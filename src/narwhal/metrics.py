...
The fleet already runs Prometheus and already scrapes `:8011/metrics`, which
answered 404 for the life of every run so far. What it wants are the numbers
...
def render(state: dict, ttft: Histogram, tpot: Histogram) -> str:
    ...
    out += _lines(
        ...
        "Flips the load condition declined",
        "counter",
