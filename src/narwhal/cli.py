...
def serve(argv: list[str] | None = None) -> int:
    ...
    # httpx logs one INFO line per engine leg, which took 5,721 of the 10,075
    # lines a 4,000-request run wrote against 1 line from the router itself.
    # Asking for debug asks for those lines, so only debug keeps them.
