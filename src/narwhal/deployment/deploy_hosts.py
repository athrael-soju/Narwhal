        ...
        if args.command == "plan":
            ...
            if args.command == "check-access":
                ...
                if manifest is None or run is None:
                    raise ValueError("Select --run for installation")
                if args.role:
                ...
                selected_host = next((h for h in hosts if args.role in h.roles), None)
                ...
                if args.command == "tunnel":
                    ...
                    try:
                        ssh.run(selected_host, "service tunnel", "", forwards=forwards)
                ...
                ssh.run(selected_host, "role shell", script, interactive=True)
