...
This is a B200 property, not a K3 one. The reference MI355X fleet carries 288 GB per GPU, 2.3 TB per node, and holds the model resident with room to spare. The CUDA sibling of that preset therefore cannot be shape-identical to it on this hardware.
