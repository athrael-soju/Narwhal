...
Restart the engine and attestation sidecar through their configured process manager. Verify the engine HTTP endpoints and sidecar attestation against the new process identity, then request readmission from the router management shell.
