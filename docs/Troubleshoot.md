...
3. Check `recovery.engine_restart_policy`. With `individual`, let the external supervisor restart the engine and its attestation sidecar. With `whole_wave`, use the complete-wave procedure below.
