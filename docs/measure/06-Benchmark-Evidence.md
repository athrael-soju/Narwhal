...
| `client/requests.jsonl`, `client/warmup.json`, `client/summary.json` | Raw client files when the client writes inside the point directory; `evidence.json` names retained files and hashes them |
