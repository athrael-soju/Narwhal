...
def test_a_pinned_prefill_with_the_default_floor_is_refused(tmp_path):
    """The reason for the rule: a pinned prefill engine with
    no floor can end up the fleet's only KV egress path."""
    cfg = _pinned_cfg(tmp_path, min_prefill=1)
