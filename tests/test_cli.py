...
EXPECTED = {
    ...
    "narwhal-drive": "narwhal.drive:main",
    # The Live Bench alias: same driver, demo-facing name.
    "narwhal-live-bench": "narwhal.drive:main",
...
def test_the_declared_scripts_are_exactly_the_expected_eight():
