...
Site automation owns host credentials, source distribution, network configuration and engine process launch. [Deploy Narwhal](docs/Deploy.md#4-qualify-the-transfer-fabric) defines the engine-facing fabric contract that automation must establish.
